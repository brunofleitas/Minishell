...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   32-exit_or_setexit.c                               :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: bfleitas <bfleitas@student.42luxembourg    +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/09/15 03:48:28 by bfleitas          #+#    #+#             */
/*   Updated: 2024/09/18 03:21:18 by bfleitas         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// /// @brief
// /// @param ec stands for "error code". It can be NULL, "00", "01",
//	"10" or "11". If an  "m" is present in the string,
//	the function will print "minishell: " before the error message. The first 
//number of the error code correspond
//
	// @param exit_code is the exit code that will be sent by the function if 
//    the error code is "10" or "11".
// /// @param cmd_ao_error
// /// @param ma
...
//     {
//         ft_putstr_fd("1: exit_or_setexit: invalid length or missing \"ec\"",
//	2);
...
//         return ;
//     }
//     if (ft_strcmp(ec, "01") == 0)
	// is usefull for exemple when an input redireciton fails but the command 
//successfully executed regardless because the redirectionfail wasn't 
//critical for the command execution
//     {
...
//     {
//         throw_error(NULL, EXIT_FAILURE,
//	"exit_or_setexit: missing \"exit_code\"", ma);
//         stop_child_or_parent(EXIT_FAILURE, ma);
//         return ;
//     }
...
static void	throw_error(int p_name, char *exit_code, char *cmd_ao_error,
		t_ma *ma)
{
	if (p_name)
